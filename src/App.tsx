...
function App() {
  ...
  return (
    ...
    >
      ...
      {automaticMapping && (
        <FigmaSyncDialog
          fileName={(projects.find((project) => project.root === automaticMapping.projectRoot) ?? activeProject).figmaFileName ?? "your Figma file"}
          operation={automaticMapping.operation}
          session={automaticMapping.session}
          status={automaticMapping.status}
